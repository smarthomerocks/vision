...
Module.register = function (name, moduleDefinition) {
	...
	if (moduleDefinition.requiresVersion) {
		console.log("Check MagicMirror version for module '" + name + "' - Minimum version:  " + moduleDefinition.requiresVersion + " - Current version: " + version);
		if (cmpVersions(version, moduleDefinition.requiresVersion) >= 0) {
			console.log("Version is ok!");
		} else {
			console.log("Version is incorrect. Skip module: '" + name + "'");
			return;
		}
	}
