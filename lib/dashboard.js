...
function Dashboard(options) {
  ...
  return {
    ...
    getModulesByName: function(name) {
      return self.modules.filter(module => module.module === name);
    },
    getModulesByPluginName: function(pluginName) {
      return self.modules.filter(module => module.config.plugin === pluginName);
    },
    getModuleById: function(id) {
      return self.modules.filter(module => module.config.id === id);
    },
