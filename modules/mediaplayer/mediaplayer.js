...
Module.register('mediaplayer', {
  ...
  getDom: function() {
    ...
    this.$el = $('<div class="box box-double media-player"><img class="albumart" src="//placehold.it/80x80" /><div class="heading">' +
        this.config.title +'</div><div class="buttons"><span class="prev"><i class="material-icons">fast_rewind</i></span><span class="play">' +
        '<i class="material-icons">play_arrow</i></span><span class="next"><i class="material-icons">fast_forward</i></span></div><div class="title">&nbsp;</div>' +
